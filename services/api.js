...
const API = axios.create({ baseURL: "http://192.168.1.94:5000" });
const API_URL = "http://192.168.1.94:5000/api/restaurants"; // Replace w
...
export const makeReservation = async ({ restaurantId, date, guestCount, customerName }) => {
  try {
    ...
    const response = await fetch("http://192.168.1.94:5000/api/reservations", {
      method: "POST",
      headers: {
